...
# A) Create five variables and assign them to strings that represent 5 common shopping list items.
...
# D) Print the name and price of each item defined above as follows:
# 1 Coco Puffs = $8.95.
# where:
